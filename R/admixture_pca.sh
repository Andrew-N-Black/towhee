# =============================================================================
# ADMIXTURE PLOT FOR THE PCAngsd K=4 SOLUTION (--admix output from pca.sh)
# Despite the .sh extension this is R code, not a shell script.
# =============================================================================

library(pophelper)
labels <- read_excel("/Users/andrew/Library/CloudStorage/Box-Box/Personal/Postdoc_Purdue/Towhee/Black_analysis/labels.xlsx")

#Maf 0.05 — ancestry barplot for the K=4 admixture (.Q) matrix from PCAngsd
...
#MAF 0.10 — same plot using the stricter MAF-filtered K=4 solution
