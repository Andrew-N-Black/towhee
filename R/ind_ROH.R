# =============================================================================
# INDIVIDUAL RUNS OF HOMOZYGOSITY (ROH) BY POPULATION
# Plots per-individual fROH (fraction of genome in ROH), split into size
# classes (100kb-1MB, >1MB, Total), and tests for population differences.
# Input generated by analyses/ROH.sh (bcftools roh).
# =============================================================================
...
#Summarize ROHs by factor: mean/sd/median/IQR of each ROH size class per population
library(dplyr)
